...
class JackAnalyzer():
    ...
    def analyze(self, root1):
        tokenizer = JackTokenizer11.JackTokenizer(root1)
        compilationEngine = JackCompilationEngine11.JackCompilationEngine(compEngOutFile)
...
if os.path.isdir(root):
    ...
    for file in tmpDirectory:
        ...
        compEngOutFile = filePath.replace(".JACK", ".txt")
        #compEngOutFile = filePath
